...
df_silver = spark.sql("select * from parquet.`abfss://silver@datalakeforcar.dfs.core.windows.net/carsales`")
...
if spark.catalog.tableExists('factsales'):
    ...
    df_fact.write.format('delta')\
        .mode('overwrite')\
        .option("path","abfss://gold@datalakeforcar.dfs.core.windows.net/factsales")\
